...
--
-- Host: localhost
-- Generation Time: Nov 23, 2021 at 06:52 AM
...
--
-- Database: `social_mediaand_misleading_information`
--
CREATE DATABASE IF NOT EXISTS `social_mediaand_misleading_information` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `social_mediaand_misleading_information`;
...
--
-- Table structure for table `remote_user_social_media`
--

CREATE TABLE IF NOT EXISTS `remote_user_social_media` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `News_Data` varchar(30000) NOT NULL,
